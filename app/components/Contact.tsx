        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:munifa.aktar@email.com" className="text-indigo-600 hover:text-indigo-700">
                    munifa.aktar@email.com
                  </a>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center text-indigo-600 hover:bg-indigo-600 hover:text-white transition-all">
          ...
          <div className="glass rounded-2xl p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 gradient-bg text-white rounded-lg font-semibold hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
                Send Message
              </button>
            </form>
