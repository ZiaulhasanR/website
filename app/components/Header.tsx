        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            >
              <Link
                  href="/experience"
                  className="text-[#ffffff] hover:text-[#6366f1] transition-colors font-medium inline-block pb-8"
              >
                Experience
              </Link>
        ...
        >
          ...
          <nav className="flex flex-col px-6 py-6 space-y-1">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:bg-white/10 px-4 py-3 rounded-lg transition-all font-medium pl-8"
                onClick={() => setMobileMenuOpen(false)}
            >
              → View Certificate
            </a>
